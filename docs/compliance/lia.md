...
| S10 | Access to Lance is controlled in Entra by two groups, reviewed in the ISO 27001 access review; a person removed from the groups is paused the next night and offboarded a week later | ADR 0020; `apps/worker/src/roles/roleCheck.ts`; [iso27001-access-review.md](iso27001-access-review.md) |
